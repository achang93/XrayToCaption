    ...
    for epoch in range(EPOCHS):
        ...
        for step, (images, texts) in enumerate(train_bar):
            ...
            inputs = processor(
                ...
                images=images,
                return_tensors="pt",
                padding="max_length", # Adjusted for SigLIP
                truncation=True
            ).to(DEVICE)
            ...
            if (step + 1) % GRAD_ACCUM_STEPS == 0:
                ...
                # Check if the scaler is going to drop the scale
                ...
                # Note: CLIP's logit_scale clamping was removed here as SigLIP 
                # learns a bias and temperature optimally via sigmoid loss.
